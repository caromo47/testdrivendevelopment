...
RSpec.describe Stringer do
	...
	it "iterates over a string and replaces each instance word with a replacement word" do
		expect(Stringer.replacify("Ruby is lame", "lame", "cool")).to eq("Ruby is cool")
	end
